    ...
    <div className="tutoring-service">
      ...
      <section>
        ...
        <ul>
          ...
          <li>Lớp nâng cao: dành cho học sinh khá và giỏi.</li>
        </ul>
        <p>
          Giáo viên có kinh nghiệm trên 10 năm giảng dạy, có giáo án phù hợp với từng đối tượng học sinh.
        </p>
        <p>
          Các bài giảng, bài kiểm tra, bài thi theo quy chuẩn của Bộ Giáo Dục và Đào Tạo.
        </p>
      </section>
